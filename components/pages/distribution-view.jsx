...
const getExpirationStatus = (dateString) => {
  ...
  if (diffDays < 0) return {
    color: 'bg-red-100 text-red-700 border-red-200', label: 'Expired', borderColor: 'border-red-500', // Adsd this
    urgent: true
  };
  if (diffDays <= 7) return {
    color: 'bg-orange-100 text-orange-800 border-orange-200', label: `${diffDays} days left`, borderColor: 'border-orange-400', // Add this
    urgent: true
  };
  if (diffDays <= 14) return { color: 'bg-yellow-50 text-yellow-700 border-yellow-200', label: 'Expiring soon', borderColor:'border-amber-400'
    , urgent: false };
