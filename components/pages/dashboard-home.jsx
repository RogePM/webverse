  ...
  return (
    <div className="max-w-7xl mx-auto pb-24 px-1 md:px-2">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-8">
        ...
        {/* Card 1: Distributions (Was Served) */}
        <ImpactCard
          title="Distributions"
        ...
        {/* Card 2: Value (Calculated Estimate) */}
        <ImpactCard
          title="Est. Value"
          value={loading ? "-" : `$${Math.round(stats.totalValue).toLocaleString()}`}
          subtitle="Market value given"
          icon={TrendingUp}
          delay={0.1}
        />

        {/* Card 3: Items Out (Was Weight) */}
        {/* Changed title to 'Items Out' since we are summing quantityDistributed */}
        <ImpactCard
          title="Items Out"
